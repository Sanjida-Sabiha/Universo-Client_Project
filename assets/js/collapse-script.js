...
function showSection(sectionId) {
    ...
    if (activeButton) {
        ...
        activeButton.style.backgroundColor = "#D5AE75"; // Change background color to active color
    ...
    if (sectionId === 'all') {
        ...
        if (allButton) {
            ...
            allButton.style.backgroundColor = "#D5AE75"; // Set background color to default
